...
const TEMAS_PG = [
  ...
  new Tema({ id: 'pg-n1-t2', nombre: 'ILIKE',                       descripcion: 'LIKE sin distinguir mayúsculas/minúsculas',    nivelId: 'pg-nivel1', orden: 2 }),
  new Tema({ id: 'pg-n1-t3', nombre: ':: (type casting)',            descripcion: 'Conversión de tipos al estilo PG',             nivelId: 'pg-nivel1', orden: 3 }),
  // Nivel 2 — Agrupación
  new Tema({ id: 'pg-n2-t1', nombre: 'string_agg()',                descripcion: 'Concatenar valores agrupados con separador',    nivelId: 'pg-nivel2', orden: 1 }),
  new Tema({ id: 'pg-n2-t2', nombre: 'array_agg()',                 descripcion: 'Agregar valores en un array',                   nivelId: 'pg-nivel2', orden: 2 }),
  // Nivel 5 — Funciones
  ...
  new Tema({ id: 'pg-n5-t4', nombre: 'GENERATE_SERIES()',           descripcion: 'Generar secuencias de números o fechas',       nivelId: 'pg-nivel5', orden: 4 }),
  // Nivel 6 — Avanzado
  new Tema({ id: 'pg-n6-t1', nombre: 'JSONB',                       descripcion: 'Operaciones con JSON binario',                 nivelId: 'pg-nivel6', orden: 1 }),
  new Tema({ id: 'pg-n6-t2', nombre: 'ARRAYS',                      descripcion: 'Tipos array nativos y operadores',             nivelId: 'pg-nivel6', orden: 2 }),
  new Tema({ id: 'pg-n6-t3', nombre: 'DISTINCT ON',                 descripcion: 'Seleccionar el primero de cada grupo',         nivelId: 'pg-nivel6', orden: 3 }),
  new Tema({ id: 'pg-n6-t4', nombre: 'ON CONFLICT (UPSERT)',        descripcion: 'INSERT ... ON CONFLICT DO UPDATE',             nivelId: 'pg-nivel6', orden: 4 }),
  new Tema({ id: 'pg-n6-t5', nombre: 'RETURNING',                   descripcion: 'Devolver filas afectadas por INSERT/UPDATE/DELETE', nivelId: 'pg-nivel6', orden: 5 }),
  new Tema({ id: 'pg-n6-t6', nombre: 'CROSSTAB',                    descripcion: 'Tablas cruzadas con tablefunc',                nivelId: 'pg-nivel6', orden: 6 }),
  new Tema({ id: 'pg-n6-t7', nombre: 'LATERAL JOIN',                descripcion: 'Subconsultas laterales',                       nivelId: 'pg-nivel6', orden: 7 }),
  // Nivel 7 — Performance
  ...
  new Tema({ id: 'pg-n7-t4', nombre: 'Índices parciales',           descripcion: 'CREATE INDEX ... WHERE condición',             nivelId: 'pg-nivel7', orden: 4 }),
  new Tema({ id: 'pg-n7-t5', nombre: 'Particionamiento declarativo', descripcion: 'PARTITION BY RANGE/LIST/HASH',               nivelId: 'pg-nivel7', orden: 5 }),
  new Tema({ id: 'pg-n7-t6', nombre: 'VACUUM',                      descripcion: 'Mantenimiento y limpieza de tablas',           nivelId: 'pg-nivel7', orden: 6 }),
  // Nivel 8 — Administración
  ...
  new Tema({ id: 'pg-n8-t5', nombre: 'LISTEN / NOTIFY',             descripcion: 'Sistema pub/sub integrado',                    nivelId: 'pg-nivel8', orden: 5 }),
  new Tema({ id: 'pg-n8-t6', nombre: 'Foreign Data Wrappers',       descripcion: 'Consultar datos de fuentes externas',          nivelId: 'pg-nivel8', orden: 6 }),
  new Tema({ id: 'pg-n8-t7', nombre: 'ENUM types',                  descripcion: 'Tipos enumerados personalizados',              nivelId: 'pg-nivel8', orden: 7 }),
  new Tema({ id: 'pg-n8-t8', nombre: 'Row-Level Security',          descripcion: 'Políticas de acceso por fila',                 nivelId: 'pg-nivel8', orden: 8 }),
];
